...
function get_sets()
	...
	WeaponIndex = 1
	WeaponArray = {"DojikiriYasutsuna","Kogarasumaru","Tsurumaru","Amanomurakumo","Masamune"} -- Default TP Set Is Dojikiri Yasutsuna. Can Delete Any Weapons/Sets That You Don't Need Or Replace/Add The New Weapons That You Want To Use. --
	IdleIndex = 1
	...
	sets.Idle.Regen.Amanomurakumo = set_combine(sets.Idle.Regen,{
			...
			range="Cibitshavore",
			ammo="Eminent Arrow"})
	sets.Idle.Regen.DojikiriYasutsuna = set_combine(sets.Idle.Regen,{
	...
	-- Dojikiri Yasutsuna(Ionis) TP Sets --
	sets.TP.DojikiriYasutsuna.Ionis = set_combine(sets.TP.DojikiriYasutsuna,{})
	sets.TP.DojikiriYasutsuna.MidACC.Ionis = set_combine(sets.TP.DojikiriYasutsuna.MidACC,{})
	sets.TP.DojikiriYasutsuna.HighACC.Ionis = set_combine(sets.TP.DojikiriYasutsuna.HighACC,{})
	sets.TP.DojikiriYasutsuna.MaxACC.Ionis = set_combine(sets.TP.DojikiriYasutsuna.MaxACC,{})

	-- Dojikiri Yasutsuna(SAM Roll) TP Sets --
	sets.TP.DojikiriYasutsuna.STP = set_combine(sets.TP.DojikiriYasutsuna,{})
	sets.TP.DojikiriYasutsuna.MidACC.STP = set_combine(sets.TP.DojikiriYasutsuna.MidACC,{})
	sets.TP.DojikiriYasutsuna.HighACC.STP = set_combine(sets.TP.DojikiriYasutsuna.HighACC,{})
	sets.TP.DojikiriYasutsuna.MaxACC.STP = set_combine(sets.TP.DojikiriYasutsuna.MaxACC,{})

	-- Dojikiri Yasutsuna(Ionis + SAM Roll) TP Sets --
	sets.TP.DojikiriYasutsuna.Ionis.STP = set_combine(sets.TP.DojikiriYasutsuna.Ionis,{})
	sets.TP.DojikiriYasutsuna.MidACC.Ionis.STP = set_combine(sets.TP.DojikiriYasutsuna.MidACC,{})
	sets.TP.DojikiriYasutsuna.HighACC.Ionis.STP = set_combine(sets.TP.DojikiriYasutsuna.HighACC,{})
	sets.TP.DojikiriYasutsuna.MaxACC.Ionis.STP = set_combine(sets.TP.DojikiriYasutsuna.MaxACC,{})
	...
	-- WS Base Set --
	sets.WS = {
			head={ name="Valorous Mask", augments={'Accuracy+27','Weapon skill damage +3%',}},
			neck="Ganesha's Mala",
			ear1="Vulcan's Pearl",
			ear2="Brutal Earring",
			--body="Nzingha Cuirass",
			hands={ name="Valorous Mitts", augments={'Accuracy+27','Weapon skill damage +4%',}},
			ring1="Ifrit Ring +1",
			ring2="Ifrit Ring +1",
			back={ name="Smertrios's Mantle", augments={'STR+20','Accuracy+20 Attack+20','Weapon skill damage +10%',}},
			waist="Metalsinger Belt",
			legs="Hiza. Hizayoroi +1",
			feet={ name="Valorous Greaves", augments={'Accuracy+22','Weapon skill damage +3%','STR+15',}}}
